...
const EnhancedTableToolbar = (props) => {
  ...
  return (
    ...
    >
    Короткая ссылка '{linkSelected}' скопирована в буффер обмена
    </Toolbar>
  );
};
          ...
          >
            ...
            <TableBody>
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected(row.short);
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, row.short)}
                      role="checkbox"
